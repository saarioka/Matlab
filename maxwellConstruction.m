% Termo LH10 teht‰v‰ 3 - Santeri Saariokari
clear all
syms t k
format short
figure
% Piirret‰‰n kuva funktiosta
v=linspace(0.6,2.5);
...
% L‰hdet‰‰n liikkeelle arvauksella 0.68
alaraja=0.68;
assume(k>0.65);
assume(k<3);
...
% Ensimm‰inen pinta-ala on suorakaide - integraali
...
% Etsit‰‰n nyt numeerisesti raja, jolloin A1=A2, ts. A1-A2=0 (l‰hes)
tic
while(A1-A2)>0,
